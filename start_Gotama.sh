...
podman exec -it mssql /opt/mssql-tools/bin/sqlcmd -S mssqlserver -U sa -P '%abcd1234%' -Q "RESTORE DATABASE GotamaMaster FROM DISK = '/data/Gotama/20220406_SQL16_MASTER_GOTAMA.BAK' WITH RECOVERY, MOVE 'GotamaV0_Data' TO '/data/Gotama/GOTAMA.mdf', MOVE 'GotamaV0_Log' TO '/data/Gotama/GOTAMA.ldf'"
